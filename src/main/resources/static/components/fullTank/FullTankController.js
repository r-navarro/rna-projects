...
.controller('FullTankController', ["$scope", "FullTankService", "VehicleService", "$routeParams", "$location", function($scope, FullTankService, VehicleService, $routeParams, $location) {
